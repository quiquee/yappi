/**
  ...
  yappipacket.cpp - Copyright (c) 2006 Todsawat Thongsuk (todsawatt@hotmail.com)
...
// SVN-ID: $Id: yappipacket.cpp 43 2006-06-12 14:04:00Z todsawat $

#include "yappipacket.h"